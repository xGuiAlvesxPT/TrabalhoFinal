...
import pt.ipg.trabalhofinal.databinding.FragmentVerJogosBinding


/**
 * A simple [Fragment] subclass.
 * Use the [FragmentVerJogos.newInstance] factory method to
...
class FragmentVerJogos : Fragment(), LoaderManager.LoaderCallbacks<Cursor> {
    ...
    override fun onCreateView(
        ...
        _binding = FragmentVerJogosBinding.inflate(inflater, container, false)
        return binding.root
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        LoaderManager.getInstance(this).initLoader(ID_LOADER_JOGOS, null, this)
