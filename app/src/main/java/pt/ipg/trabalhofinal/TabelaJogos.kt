...
class TabelaJogos( db: SQLiteDatabase): TabelaBD(db, NOME) {
   ...
   override fun cria (){
        ...
        db.execSQL("CREATE TABLE $NOME (${BaseColumns._ID} INTEGER PRIMARY KEY AUTOINCREMENT, $NOME_JOGO TEXT NOT NULL,$PRECO REAL NOT NULL , $GENERO TEXT NOT NULL, $PUBLICADORA TEXT NOT NULL,$DATA_DE_LANCAMENTO TEXT NOT NULL,$CAMPO_FK_PLATAFORMA INTEGER NOT NULL,FOREIGN KEY($CAMPO_FK_PLATAFORMA) REFERENCES ${TabelaPlataformas.NOME} (${BaseColumns._ID}) ON DELETE RESTRICT) ")
    }
