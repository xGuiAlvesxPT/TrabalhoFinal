...
class FragmentVerFuncionarios : Fragment(), LoaderManager.LoaderCallbacks<Cursor>{
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        LoaderManager.getInstance(this).initLoader(ID_LOADER_FUNCIONARIOS, null, this)
    ...
    override fun onLoadFinished(loader: Loader<Cursor>, data: Cursor?) {
        adapterFuncionarios!!.cursor = data
    }
    ...
    override fun onLoaderReset(loader: Loader<Cursor>) {
        adapterFuncionarios!!.cursor = null
    }

    companion object {
        const val ID_LOADER_FUNCIONARIOS = 0
    }
}